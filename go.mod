// Generated/created from WORKSPACE. DO NOT EDIT
// Note: this is a temporary solution. In scionproto/scion:master, go.mod is
// the master that is used to generate WORKSPACE.
